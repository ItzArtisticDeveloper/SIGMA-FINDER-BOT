class script(object):
    START_TXT = """ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ <a href=https://t.me/{}>{}</a>
Yᴏᴜʀ ᴏɴᴇ-ѕᴛᴏᴘ ᴅᴇѕᴛɪɴᴀᴛɪᴏɴ ꜰᴏʀ ѕᴇᴀᴍʟᴇѕѕ ᴍᴏᴠɪᴇ ᴅᴏᴡɴʟᴏᴀᴅѕ. Eхᴘʟᴏʀᴇ ᴏᴜʀ ᴀʀʀᴀʏ ᴏꜰ ꜰᴇᴀᴛᴜʀᴇѕ ᴅᴇѕɪɢɴᴇᴅ ᴛᴏ ᴇɴʜᴀɴᴄᴇ ʏᴏᴜʀ ᴍᴏᴠɪᴇ ᴇxᴘᴇʀɪᴇɴᴄᴇ. Gᴇᴛ ʀᴇᴀᴅʏ ᴛᴏ ᴅɪᴠᴇ ɪɴᴛᴏ ᴛʜᴇ ᴡᴏʀʟᴅ ᴏꜰ ᴄɪɴᴇᴍᴀ ᴡɪᴛʜ ᴇᴀꜱᴇ ᴀɴᴅ ᴄᴏɴᴠᴇɴɪᴇɴᴄᴇ!.\n\nᴍᴀɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/BurdenOfEarth">Sᴏᴍᴇᴏɴᴇ 🙂</a>"""
...
ᴡᴇ ʜᴀᴠᴇ ᴅᴇᴠɪᴅᴇᴅ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ ꜰᴏʀ ɢʀᴏᴜᴘ ᴏᴡɴᴇʀꜱ ᴀɴᴅ ʙᴏᴛ ᴜꜱᴇʀꜱ.</b>"""
    ...
    ABOUT_TXT = """<b>‣ ᴍʏ ɴᴀᴍᴇ : {}\n‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/BurdenOfEarth'>Sᴏᴍᴇᴏɴᴇ 🙂</a>\n‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ\n‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ\n‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\n‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ʜᴇʀᴏᴋᴜ\n‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ4.2 [sᴛᴀʙʟᴇ]</b>"""
    
    CHANNELS = """
<b>⚡ ɢʀᴏᴜᴘs & ᴄʜᴀɴɴᴇʟs ɪɴғᴏ ⚡ 

▫ ᴀʟʟ ɴᴇᴡ ᴍᴏᴠɪᴇs & sᴇʀɪᴇs.
▫ ꜰᴀsᴛᴇsᴛ ʙᴏᴛs ᴀʀᴇ ᴀᴅᴅᴇᴅ.
▫ ꜰʀᴇᴇ & ᴇᴀsʏ ᴛᴏ ᴜsᴇ.
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/BurdenOfEarth'>Sᴏᴍᴇᴏɴᴇ 🙂</a></b>"""
